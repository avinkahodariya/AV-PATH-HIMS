...
export function AddEditMaterialOutwardReturnable() {
  ...
  return (
    <>
      ...
      />
      <AddEditMaterialOutwardReturnableModal
...
export const AddEditMaterialOutwardReturnableModal = ({ data, mode, open, onClose, onSubmit }) => {
  ...
  console.log("🚀 ~ file: AddEditKey.jsx:123 ~ AddEditMaterialOutwardReturnableModal ~ errors:", errors)
  useEffect(() => {
    if (open) {
  ...
  return (
    <PopUpModal open={open}>
      <ModalHeader mode={mode} title="Material Outward  Returnable" />
