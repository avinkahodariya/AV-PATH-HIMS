...
import {EditContactDetailsAddPopup} from "components";
import {EditContactDetailsEditPopup} from "components";

export function EditContactDetails({ next, back, onCancel }) {
                        ...
                        <table className="w-full custom-table" border={1}>
                            <thead>
                                <tr className="table-heading">
                                    ...
                                    <td>Mobile Number</td>
                                    <td>Alternet Mobile Number</td>
                                    <td>Email Id</td>
                                    <td>Alternet Email Id</td>
                                    <td>Designation</td>
                                    <td>Created Date</td>
                                    <td>Created By</td>
                                    <td>Action</td>
