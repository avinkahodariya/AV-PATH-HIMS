...
export const AddEditWaterCanModal = ({ data, mode, open, onClose, onSubmit }) => {
  ...
  console.log("🚀 ~ file: AddEditKey.jsx:123 ~ AddEditWaterCanModal ~ errors:", errors)
  useEffect(() => {
    if (open) {
      ...
      <div className="p-4 w-[65vw]">
        <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
          ...
          <FormTextField
            ...
            name="NoofWaterCansDelivered"
            errors={errors?.NoofWaterCansDelivered}
          />
          <FormTextField
            control={control}
            label="No of Water Empty Cans taken"
            name="NoofWaterEmptyCanstaken"
            errors={errors?.NoofWaterEmptyCanstaken}
          />
          <FormCheckBox
            control={control}
