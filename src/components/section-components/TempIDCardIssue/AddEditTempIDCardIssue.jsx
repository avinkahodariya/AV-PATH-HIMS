...
export function AddEditTempIDCardIssue() {
  ...
  const columns = [
    ...
    { header: "ID Card No", field: "ID Card No" },
    { header: "Reason for issuance", field: "Reason for issuance" },
...
export const AddEditTempIDCardIssueModal = ({ data, mode, open, onClose, onSubmit }) => {
  ...
  console.log("🚀 ~ file: AddEditKey.jsx:123 ~ AddEditTempIDCardIssueModal ~ errors:", errors)
  useEffect(() => {
    if (open) {
  ...
  return (
    <PopUpModal open={open}>
      <ModalHeader mode={mode} title="Temp ID Card Issue" />
      <div className="p-4 w-[65vw]">
        <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
          ...
          <FormTextField
            ...
            errors={errors?.Reasonforissuance}
          />
          <FormTextField
            control={control}
            label="Description"
          ...
          <FormTextField
            ...
            type="datetime-local"
            errors={errors?.ReturndateandTime}
          />
          <FormTextField
            control={control}
            label="Remarks"
