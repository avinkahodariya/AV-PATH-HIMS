...
export const ManageTerritoryAdd = ({ checkboxAdd, setCheckboxAdd, onSubmit, onCancel }) => {
                    ...
                    <div className="w-[700px] grid grid-cols-2 gap-4 md:grid-cols-3">
                        ...
                        <div className="py-1 flex items-end">
                            ...
                            <div className="flex gap-1 items-center">
                                <div
                                    className={`${checkboxAdd ? "bg-prp-color" : "bg-white"
                                        } border flex justify-center items-center rounded h-[34px] w-[34px]`}
                                    onClick={() => setCheckboxAdd(!checkboxAdd)}
                                >
