...
function EmployeeProfileEdit({ statusEmployeeHistoryEdit, setStatusEmployeeHistoryEdit, onSubmit, onCancel }) {
    let [checkboxWebUserEmployeeHisEdit, setCheckboxWebUserEmployeeHisEdit] = useState(true);
    let [checkboxMobileUserEmployeeHisEdit, setCheckboxMobileUserEmployeeHisEdit] = useState(true);
        ...
        <>
            <div className="bg-white min-w-[350px] pb-5 rounded-lg overflow-visible">
                ...
                <div className="flex bg-prp-color p-4 text-white justify-between rounded-t-lg">
                    <h1 className="text-l font-weight-[300]">Edit Employee History</h1>
                ...
                <div className="p-4 gap-4 max-h-[70vh] overflow-y-auto max-w-full w-[1100px]">
                    ...
                    <Accordion title="Other Details">
                        ...
                        <div className="grid grid-cols-1  gap-4 md:grid-cols-3 ">
                            ...
                            <CustomCheckBox3
                                label={"Is Web User"}
                                state={checkboxWebUserEmployeeHisEdit}
                                setState={setCheckboxWebUserEmployeeHisEdit}
                            >
                            </CustomCheckBox3>
                            <CustomCheckBox3
                                label={"Is Mobile User"}
                                state={checkboxMobileUserEmployeeHisEdit}
                                setState={setCheckboxMobileUserEmployeeHisEdit}
                            >
                            </CustomCheckBox3>
                            <CustomCheckBox3
                                label={"Is Active"}
                                state={statusEmployeeHistoryEdit}
                                setState={setStatusEmployeeHistoryEdit}
                            >
                            </CustomCheckBox3>
