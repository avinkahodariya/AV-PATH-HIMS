...
export function EmployeeProfileEdit({ statusEmployeeEdit, setStatusEmployeeEdit, onSubmit, onCancel }) {
    let [checkboxWebUserEmployeeEdit, setCheckboxWebUserEmployeeEdit] = useState(true);
    let [checkboxMobileUserEmployeeEdit, setCheckboxMobileUserEmployeeEdit] = useState(true);
                ...
                <div className="p-4 gap-4 max-h-[70vh] overflow-y-auto max-w-full w-[1100px]">
                    ...
                    <Accordion title="Other Details">
                        ...
                        <div className="grid grid-cols-1  gap-4 md:grid-cols-3 ">
                            ...
                            <CustomCheckBox3
                                label={"Is Web User"}
                                state={checkboxWebUserEmployeeEdit}
                                setState={setCheckboxWebUserEmployeeEdit}
                            >
                            </CustomCheckBox3>
                            <CustomCheckBox3
                                label={"Is Mobile User"}
                                state={checkboxMobileUserEmployeeEdit}
                                setState={setCheckboxMobileUserEmployeeEdit}
                            >
                            </CustomCheckBox3>
                            <CustomCheckBox3
                                label={"Is Active"}
                                state={statusEmployeeEdit}
                                setState={setStatusEmployeeEdit}
                            >
                            </CustomCheckBox3>
