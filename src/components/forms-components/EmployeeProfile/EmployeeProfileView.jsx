...
export function EmployeeProfileView({ statusEmployeeView, setStatusEmployeeView, onCancel }) {
          ...
          <div key={index} className="p-4 gap-4 max-h-[70vh] overflow-y-auto ">
            ...
            <Accordion title="Permanent Address">
              <div className="grid grid-cols-1  gap-4 md:grid-cols-3 ">
                ...
                <CustomViewLabel label="Country" value={emp.region} />
            ...
            <Accordion title="Temporary Address">
              <div className="grid grid-cols-1  gap-4 md:grid-cols-3 ">
                ...
                <CustomViewLabel label="Country" value={emp.T_region} />
            ...
            <Accordion title="Other Details">
              <div className="grid grid-cols-1  gap-4 md:grid-cols-3 ">
                ...
                <CustomCheckBox2
                  label={"Is Active"}
                  state={statusEmployeeView}
                  setState={setStatusEmployeeView}
                  disabled={true}
                ></CustomCheckBox2>
