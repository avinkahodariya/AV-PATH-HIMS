...
export function ManageOrderUnderProcessAdd({ onCancel }) {
        ...
        <>
            <div className="pb-10 bg-white rounded-lg">
                <div className="flex bg-prp-color p-2 text-white justify-between rounded-t-lg">
                    <h1 className=" font-weight-[400]">Add Order Under Process</h1>
                ...
                <div className="flex justify-center gap-5">
                    <div>
                        <CustomButton1 label={"Add"} className="text-white bg-prp-color" />
                    </div>
