...
export const ManageCompanyDetailAdd = ({ checkboxCompanyNameAdd, setCheckboxCompanyNameAdd, onSubmit, onCancel }) => {
  ...
  return (
    <div className="pb-10 bg-white rounded-lg">
      <div className="flex bg-prp-color p-4 text-white justify-between rounded-t-lg">
        <h1 className="text-xl font-weight-[400]">Add Company</h1>
