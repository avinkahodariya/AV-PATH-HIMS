...
import {ManagePOAdd} from "components";
import {ManagePOIssuedAdd} from "components";
...
export function ManageTrackingStatus() {
                            ...
                            <div className="row flex justify-content-between">
                                <div className="order-tracking completed">
                                    ...
                                    <div className="flex flex-col justify-center gap-1 items-center">
                                        ...
                                        <div className="flex gap-2">
                                            <button onClick={() => setPopupAddOne(true)} className="bg-white txt-prp-color border border-prp px-1 py-0 rounded">
                                                <IoMdAdd h-8 w-8 />
                                            </button>
                                ...
                                <div className="order-tracking completed">
                                    ...
                                    <div className="flex flex-col justify-center gap-1 items-center">
                                        ...
                                        <div className="text-xs ">Uploaded By: <span>User</span></div>
                                        <div className="flex gap-2">
                                            <button onClick={() => setPopupAddTwo(true)} className="bg-white txt-prp-color border border-prp px-1 py-0 rounded">
                                                <IoMdAdd h-8 w-8 />
                                            </button>
                                ...
                                <div className="order-tracking-revs completed">
                                    ...
                                    <div className="flex flex-col justify-center items-center">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <button onClick={() => setPopupAddThree(true)} className="bg-white txt-prp-color border border-prp px-1 py-0 rounded">
                                                <IoMdAdd h-8 w-8 />
                                            </button>
                                        </div>
            ...
            {popupAddThree && (
                <PopUp>
                    <PaymentLCReceivedAdd
                        onCancel={() => setPopupAddThree(false)}
                    />
                </PopUp>
            )}
