...
import {ManagePOIssuedEdit} from "components";
import {ManagePOIssuedView} from "components";
...
export function ManagePOIssued() {
    ...
    return (
        <div className="flex flex-col h-full p-2 uppercase">
            <div className="p-4 mt-2 bg-white rounded grow" style={{ border: "1px solid #3D3D3D66" }}>
                <Title title1={"Manage PI Issued"} title2={"Manage Tracking"} />
