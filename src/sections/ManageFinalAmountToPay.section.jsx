...
import { ManageFinalAmountToPayAdd } from "components";
import { ManageFinalAmountToPayEdit } from "components";
import { ManageFinalAmountToPayView } from "components";
...
export function ManageFinalAmountToPay() {
    ...
    return (
        <div className="flex flex-col h-full p-2 uppercase">
            <div className="p-4 mt-2 bg-white rounded grow" style={{ border: "1px solid #3D3D3D66" }}>
                <Title title1={"Manage Final Amount To Pay"} title2={"Manage Tracking"} />
