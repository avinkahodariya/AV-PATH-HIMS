...
import {ManagePIConfirmedbyCustomerAdd} from "components";
import {ManagePIConfirmedbyCustomerEdit} from "components";
import {ManagePIConfirmedbyCustomerView} from "components";
...
export function ManagePIConfirmedbyCustomer() {
        ...
        <div className="flex flex-col h-full p-2 uppercase">
            <div className="p-4 mt-2 bg-white rounded grow" style={{ border: "1px solid #3D3D3D66" }}>
                ...
                <div className=" bg-white rounded grow">
                    ...
                    {popupAdd && (
                        <PopUp>
                            <ManagePIConfirmedbyCustomerAdd
                    ...
                    {popupEdit && (
                        <PopUp>
                            <ManagePIConfirmedbyCustomerEdit
