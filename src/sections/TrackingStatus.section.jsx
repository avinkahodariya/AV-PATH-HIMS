...
export function TrackingStatus() {
    ...
    const [trackAdd, setTrackAdd] = useState("");
    ...
    return (
        <div className="flex flex-col h-full p-2 uppercase">
            <div className="p-4 mt-2 bg-white rounded grow" style={{ border: "1px solid #3D3D3D66" }}>
                <Title title1={"Admin Tracking Status"} title2={"ADMINISTRATOR"} />
                ...
                <div className=" bg-white rounded grow">
                        ...
                        <PopUp>
                            <div className="pb-10 bg-white rounded-lg">
                                <div className="flex bg-prp-color p-2 text-white justify-between rounded-t-lg">
                                    <h1 className="text-l font-weight-[400]">Add Tracking Status</h1>
                                    ...
                                    <table className="max-w-full popup-table">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <CustomTextField2
                                                        label={"Admin Tracking Name"}
                                                        placeholder={"ENTER"}
                                                        value={trackAdd}
                                                        onChange={setTrackAdd} 
                                                    ></CustomTextField2>
                                                </td>
                                                <td>
                                                    <CustomCheckBox2
                    ...
                    {popupEdit && (
                        <PopUp>
                            <div className="pb-10 bg-white rounded-lg">
                                <div className="flex bg-prp-color p-2 text-white justify-between rounded-t-lg">
                                    <h1 className=" font-weight-[400]">Edit Tracking Status</h1>
                                    <div className="flex items-center text-sm"></div>
                                </div>
