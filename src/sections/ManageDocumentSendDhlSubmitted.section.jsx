...
import { ManageDocumentSendAdd } from "components";
import { ManageDocumentSendEdit } from "components";
import { ManageDocumentSendView } from "components";
...
export function ManageDocumentSendDhlSubmitted() {
    ...
    return (
        <div className="flex flex-col h-full p-2 uppercase">
            <div className="p-4 mt-2 bg-white rounded grow" style={{ border: "1px solid #3D3D3D66" }}>
                <Title title1={"Manage Document Send Dhl / Submitted"} title2={"Manage Tracking"} />
