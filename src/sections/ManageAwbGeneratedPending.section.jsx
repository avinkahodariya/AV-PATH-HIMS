...
import {ManageAwbGeneratedPendingAdd} from "components";
import {ManageAwbGeneratedPendingEdit} from "components";
import {ManageAwbGeneratedPendingView} from "components";
...
export function ManageAwbGeneratedPending() {
    ...
    return (
        <div className="flex flex-col h-full p-2 uppercase">
            <div className="p-4 mt-2 bg-white rounded grow" style={{ border: "1px solid #3D3D3D66" }}>
                <Title title1={"Manage Awb Generated Pending"} title2={"Manage Tracking"} />
