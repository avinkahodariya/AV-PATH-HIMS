...
export function ManagePortDischarge() {
    let [popupPortDischargeAdd, setPopupPortDischargeAdd] = useState(false);
    let [popupPortDischargeEdit, setPopupPortDischargeEdit] = useState(false);
    let [checkboxPortDischargeAdd, setCheckboxPortDischargeAdd] = useState(true);
    let [checkboxPortDischargeEdit, setCheckboxPortDischargeEdit] = useState(true);

    const [portCodeAdd, setPortCodeAdd] = useState("");
    const [portDisAdd, setPortDisAdd] = useState("");
    const [portCodeEdit, setPortCodeEdit] = useState("");
    const [portDisEdit, setPortDisEdit] = useState("");
    ...
    return (
        <div className="flex flex-col h-full p-2 uppercase">
            <div className="p-4 mt-2 bg-white rounded grow" style={{ border: "1px solid #3D3D3D66" }}>
                <Title title1={"Admin Port Discharge"} title2={"ADMINISTRATOR"} />
                ...
                <div className=" bg-white rounded grow">
                    <div className="px-2 lg:px-4">
                        ...
                        <div className="flex flex-row flex-wrap justify-start gap-2 mt-5 md:flex-nowrap minbox">
                            <CustomButton1
                                ...
                                onClick={() => setPopupPortDischargeAdd(true)}
                            />
                                        ...
                                        <td>
                                            <div>
                                                <CustomButton1
                                                    ...
                                                    icon={<BiEdit />}
                                                    onClick={() => setPopupPortDischargeEdit(true)}
                                                />
                                            </div>
                                        </td>
                        ...
                        <PopUp>
                            <div className="pb-10 bg-white rounded-lg">
                                    ...
                                    <table className="w-[100%] mx-auto popup-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="align-bottom w-[50%]">
                                                    <CustomCheckBox2
                                                        label={"Is Active"}
                                                        state={checkboxPortDischargeAdd}
                                                        setState={setCheckboxPortDischargeAdd}
                                                    ></CustomCheckBox2>
                                                </td>
                                            </tr>
                                        </tbody>
                                ...
                                <div className="flex justify-center gap-5">
                                    ...
                                    <div onClick={() => setPopupPortDischargeAdd(false)}>
                    ...
                    {/* POPUP 2 : EDIT */}
                    {popupPortDischargeEdit && (
                        <PopUp>
                            <div className="pb-10 bg-white rounded-lg">
                                <div className="flex bg-prp-color p-2 text-white justify-between rounded-t-lg">
                                    <h1 className=" font-weight-[400]">Edit Port Discharge</h1>
                                    <div className="flex items-center text-sm"></div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="align-bottom w-[50%]">
                                                    <CustomCheckBox2
                                                        label={"Is Active"}
                                                        state={checkboxPortDischargeEdit}
                                                        setState={setCheckboxPortDischargeEdit}
                                                    ></CustomCheckBox2>
                                                </td>
                                            </tr>
                                        </tbody>
                                ...
                                <div className="flex justify-center gap-5">
                                    ...
                                    <div onClick={() => setPopupPortDischargeEdit(false)}>
                                        <CustomButton1 label={"Cancel"} variant="outlined" className="txt-prp-color" />
                                    </div>
                                </div>
                            </div>
