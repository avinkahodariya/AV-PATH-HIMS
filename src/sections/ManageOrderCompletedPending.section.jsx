...
import {ManageOrderCompletedPendingAdd} from "components";
import {ManageOrderCompletedPendingEdit} from "components";
import {ManageOrderCompletedPendingView} from "components";
...
export function ManageOrderCompletedPending() {
    ...
    return (
        <div className="flex flex-col h-full p-2 uppercase">
            <div className="p-4 mt-2 bg-white rounded grow" style={{ border: "1px solid #3D3D3D66" }}>
                <Title title1={"Manage Order Completed Pending"} title2={"Manage Tracking"} />
                ...
                <div className=" bg-white rounded grow">
                    ...
                    {popupAdd && (
                        <PopUp>
                            <ManageOrderCompletedPendingAdd
                    ...
                    {popupEdit && (
                        <PopUp>
                            <ManageOrderCompletedPendingEdit
