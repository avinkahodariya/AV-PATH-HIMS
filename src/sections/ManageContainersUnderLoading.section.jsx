...
import {ManageContainersUnderLoadingAdd} from "components";
import {ManageContainersUnderLoadingEdit} from "components";
import {ManageContainersUnderLoadingView} from "components";
...
export function ManageContainersUnderLoading() {
    ...
    return (
        <div className="flex flex-col h-full p-2 uppercase">
            <div className="p-4 mt-2 bg-white rounded grow" style={{ border: "1px solid #3D3D3D66" }}>
                <Title title1={"Manage Containers Under Loading"} title2={"Manage Tracking"} />
                ...
                <div className=" bg-white rounded grow">
                    ...
                    {popupAdd && (
                        <PopUp>
                            <ManageContainersUnderLoadingAdd
                    ...
                    {popupEdit && (
                        <PopUp>
                            <ManageContainersUnderLoadingEdit
