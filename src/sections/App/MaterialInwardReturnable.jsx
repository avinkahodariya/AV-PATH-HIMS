...
// COMPONENTS
import { AddEditMaterialInwardReturnable, Title } from "components";


export function MaterialInwardReturnable() {
    return (
        <div className="flex flex-col h-full uppercase">
            <div className="p-6 mt-2 bg-white rounded grow" style={{ border: "1px solid #3D3D3D66" }}>
                <Title title1={"Material Inward Returnable"} />
                ...
                <AddEditMaterialInwardReturnable />
            </div >
        </div >
    );
}